...
ALTER TABLE sign.highwaysign ADD COLUMN has_processed boolean default false;
...
create view sign.vwhugohighwaysign
            (id, title, sign_description, feature_id, date_taken, imageid, flickrid, point, country_slug, state_slug,
             place_slug, county_slug, tags, categories, highways, is_to, image_height, image_width, quality, lqip_hash, has_processed)
as
SELECT hs.id,
       hs.title,
       hs.sign_description,
...
create view sign.vwhugohighwaysign
            (id, title, sign_description, feature_id, date_taken, imageid, flickrid, point, country_slug, state_slug,
             place_slug, county_slug, tags, categories, highways, is_to, image_height, image_width, quality, lqip_hash)
as
SELECT hs.id,
       hs.title,
       hs.sign_description,
...
ALTER TABLE sign.highwaysign DROP COLUMN has_processed;
-- +goose StatementEnd
